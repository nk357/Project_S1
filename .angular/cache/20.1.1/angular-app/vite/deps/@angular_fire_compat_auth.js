import "./chunk-F2GIKCF7.js";
import "./chunk-YLB7YJVO.js";
import {
  firebase
} from "./chunk-FWNO2U4S.js";
import {
  AppCheckInstances
} from "./chunk-SQ3JS5GE.js";
import {
  VERSION as VERSION2,
  pendingUntilEvent,
  ɵAngularFireSchedulers
} from "./chunk-JSWLKDW4.js";
import "./chunk-EXG5JI5D.js";
import {
  isPlatformServer
} from "./chunk-XLIBRSRV.js";
import {
  EnvironmentInjector,
  Inject,
  Injectable,
  ...
  ɵɵdefineNgModule,
  ɵɵinject
} from "./chunk-ZROVITPJ.js";
import "./chunk-UGVWIBBR.js";
import "./chunk-KIKWU6J4.js";
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-HBPKDGMR.js"))), map(() => ɵfirebaseAppFactory(options, zone, name)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
